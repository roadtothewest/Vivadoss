...
HD_PWD='/home/sysmic/Vivadoss/TAREA1/TAREA1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cronometer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cronometer.tcl -notrace
