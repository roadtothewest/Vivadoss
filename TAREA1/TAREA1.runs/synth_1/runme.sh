...
HD_PWD='/home/sysmic/Vivadoss/TAREA1/TAREA1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cronometer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cronometer.tcl
